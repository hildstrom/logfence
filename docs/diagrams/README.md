...
| `02-crate-dependencies.puml` | Package/Component | The four crates, their key contents, and which depends on which | [crate-dependencies.svg](crate-dependencies.svg) |
